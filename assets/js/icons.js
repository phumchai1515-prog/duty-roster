/**
 * icons.js — ไอคอน SVG แบบฝังในโค้ด
 * ไม่พึ่ง CDN ภายนอก เพื่อให้เว็บโหลดได้แม้เครือข่ายโรงพยาบาลบล็อก
 * ทุกไอคอนเป็น stroke 1.75 ขนาด 24 กริดเดียวกัน จึงดูเป็นชุดเดียว
 */
const paths = {
  calendar: '<rect x="3" y="5" width="18" height="16" rx="2"/><path d="M3 10h18M8 3v4M16 3v4"/>',
  user: '<path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/>',
  printer: '<path d="M6 9V3h12v6M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2"/><rect x="6" y="14" width="12" height="8" rx="1"/>',
...
/**
 * คืนสตริง SVG พร้อมใช้ใน template
...
export function icon(name, { size = 24, className = '' } = {}) {
  ...
  return `<svg viewBox="0 0 24 24" width="${size}" height="${size}" fill="none"
    ...
    ${className ? `class="${className}" ` : ''}aria-hidden="true" focusable="false">${body}</svg>`;
}
